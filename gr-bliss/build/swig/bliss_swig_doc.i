...
%feature("docstring") bliss_correlator_vcvc "<+description+>"

%feature("docstring") bliss_correlator_vcvc::bliss_correlator_vcvc "
...
%feature("docstring") bliss_correlator_vcvc::general_work "

Params: (noutput_items, ninput_items, input_items, output_items)"

%feature("docstring") bliss_make_correlator_vcvc "<+description+>
